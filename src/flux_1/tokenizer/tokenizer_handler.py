...
class TokenizerHandler:
    ...
    @staticmethod
    def load_from_cache_or_huggingface(repo_id: str, max_t5_length: int = 256, local_path: str | None = None) -> "TokenizerHandler":
        return TokenizerHandler(repo_id, max_t5_length, local_path)
