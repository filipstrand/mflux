...
from transformers import Qwen2VLImageProcessor  # noqa: E402

from mflux.models.qwen.tokenizer.qwen_image_processor import QwenImageProcessor  # noqa: E402
...
print(f"Grid tensor height-width match: {np.array_equal(mlx_grid_thw, hf_grid_thw)}")
