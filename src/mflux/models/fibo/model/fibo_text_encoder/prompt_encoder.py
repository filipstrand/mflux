...
class PromptEncoder:
    ...
    def encode_prompt(
        ...
        neg_prompt_embeds, neg_prompt_layers, neg_prompt_attention_mask = PromptEncoder.get_prompt_embeds(
    ...
    def _get_encoder_hidden_states(neg_prompt_attention_mask, neg_prompt_embeds, prompt_attention_mask, prompt_embeds):
        ...
        prompt_embeds, prompt_attention_mask = PromptEncoder.pad_embedding(
            max_tokens=max_tokens,
            prompt_embeds=prompt_embeds,
            attention_mask=prompt_attention_mask,
        )
        neg_prompt_embeds, neg_prompt_attention_mask = PromptEncoder.pad_embedding(
            max_tokens=max_tokens,
    ...
    def _get_prompt_layers(max_tokens, neg_prompt_layers, prompt_layers):
        prompt_layers = [PromptEncoder.pad_embedding(layer, max_tokens)[0] for layer in prompt_layers]
        neg_prompt_layers = [PromptEncoder.pad_embedding(layer, max_tokens)[0] for layer in neg_prompt_layers]
