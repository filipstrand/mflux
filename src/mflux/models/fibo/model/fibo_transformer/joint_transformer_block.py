...
class FiboJointTransformerBlock(nn.Module):
    ...
    def __init__(self, dim: int, num_attention_heads: int, attention_head_dim: int, eps: float = 1e-6):
        ...
        # Joint attention; the implementation already matches BriaFiboAttention semantics
    ...
    def __call__(
        ...
        # IP-Adapter path is intentionally ignored here; JointAttention returns 2 tensors.
