...
class FIBOWeightMapping(WeightMapping):
    ...
    def get_transformer_mapping() -> List[WeightTarget]:
        """
        Declarative mapping for the Bria FIBO transformer.

        The MLX FiboTransformer is structured to mirror the diffusers
        BriaFiboTransformer2DModel closely, so most mappings are 1:1:
        the mlx_path and hf_patterns entries are identical and we rely
        on WeightMapper to build the nested/list structure.
        """
