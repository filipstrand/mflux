        ...
        return [
            LoRATarget(
                ...
                possible_up_patterns=[
                    ...
                    "diffusion_model.all_x_embedder.2-1.lora_B.default.weight",
                    "transformer.all_x_embedder.2-1.lora_B.weight",
                    "transformer.all_x_embedder.2-1.lora_B.default.weight",
                ],
                possible_down_patterns=[
                    "diffusion_model.all_x_embedder.2-1.lora_A.weight",
                    "diffusion_model.all_x_embedder.2-1.lora_A.default.weight",
                    "transformer.all_x_embedder.2-1.lora_A.weight",
                    "transformer.all_x_embedder.2-1.lora_A.default.weight",
                ],
            ),
            LoRATarget(
                ...
                possible_up_patterns=[
                    ...
                    "diffusion_model.all_final_layer.2-1.linear.lora_B.default.weight",
                    "transformer.all_final_layer.2-1.linear.lora_B.weight",
                    "transformer.all_final_layer.2-1.linear.lora_B.default.weight",
                ],
                possible_down_patterns=[
                    "diffusion_model.all_final_layer.2-1.linear.lora_A.weight",
                    "diffusion_model.all_final_layer.2-1.linear.lora_A.default.weight",
                    "transformer.all_final_layer.2-1.linear.lora_A.weight",
                    "transformer.all_final_layer.2-1.linear.lora_A.default.weight",
                ],
            ),
            LoRATarget(
                ...
                possible_up_patterns=[
                    ...
                    "diffusion_model.all_final_layer.2-1.adaLN_modulation.1.lora_B.default.weight",
                    "transformer.all_final_layer.2-1.adaLN_modulation.1.lora_B.weight",
                    "transformer.all_final_layer.2-1.adaLN_modulation.1.lora_B.default.weight",
                ],
                possible_down_patterns=[
                    "diffusion_model.all_final_layer.2-1.adaLN_modulation.1.lora_A.weight",
                    "diffusion_model.all_final_layer.2-1.adaLN_modulation.1.lora_A.default.weight",
                    "transformer.all_final_layer.2-1.adaLN_modulation.1.lora_A.weight",
                    "transformer.all_final_layer.2-1.adaLN_modulation.1.lora_A.default.weight",
                ],
            ),
            LoRATarget(
                ...
                possible_up_patterns=[
                    ...
                    "diffusion_model.cap_embedder.1.lora_B.default.weight",
                    "transformer.cap_embedder.1.lora_B.weight",
                    "transformer.cap_embedder.1.lora_B.default.weight",
                ],
                possible_down_patterns=[
                    "diffusion_model.cap_embedder.1.lora_A.weight",
                    "diffusion_model.cap_embedder.1.lora_A.default.weight",
                    "transformer.cap_embedder.1.lora_A.weight",
                    "transformer.cap_embedder.1.lora_A.default.weight",
                ],
            ),
            LoRATarget(
                ...
                possible_up_patterns=[
                    ...
                    "diffusion_model.t_embedder.mlp.0.lora_B.default.weight",
                    "transformer.t_embedder.mlp.0.lora_B.weight",
                    "transformer.t_embedder.mlp.0.lora_B.default.weight",
                ],
                possible_down_patterns=[
                    "diffusion_model.t_embedder.mlp.0.lora_A.weight",
                    "diffusion_model.t_embedder.mlp.0.lora_A.default.weight",
                    "transformer.t_embedder.mlp.0.lora_A.weight",
                    "transformer.t_embedder.mlp.0.lora_A.default.weight",
                ],
            ),
            LoRATarget(
                ...
                possible_up_patterns=[
                    ...
                    "diffusion_model.t_embedder.mlp.2.lora_B.default.weight",
                    "transformer.t_embedder.mlp.2.lora_B.weight",
                    "transformer.t_embedder.mlp.2.lora_B.default.weight",
                ],
                possible_down_patterns=[
                    "diffusion_model.t_embedder.mlp.2.lora_A.weight",
                    "diffusion_model.t_embedder.mlp.2.lora_A.default.weight",
                    "transformer.t_embedder.mlp.2.lora_A.weight",
                    "transformer.t_embedder.mlp.2.lora_A.default.weight",
                ],
            ),
        ]
        ...
        return [
            LoRATarget(
                ...
                possible_up_patterns=[
                    ...
                    f"diffusion_model.{layer_type}.{{block}}.adaLN_modulation.0.lora_B.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.adaLN_modulation.0.lora_up.weight",
                    f"diffusion_model.{layer_type}.{{block}}.adaLN_modulation.0.lora_up.default.weight",
                    f"transformer.{layer_type}.{{block}}.adaLN_modulation.0.lora_B.weight",
                    f"transformer.{layer_type}.{{block}}.adaLN_modulation.0.lora_B.default.weight",
                    f"transformer.{layer_type}.{{block}}.adaLN_modulation.0.lora_up.weight",
                    f"transformer.{layer_type}.{{block}}.adaLN_modulation.0.lora_up.default.weight",
                    f"{layer_type}.{{block}}.adaLN_modulation.0.lora_B.weight",
                    f"{layer_type}.{{block}}.adaLN_modulation.0.lora_B.default.weight",
                    f"{layer_type}.{{block}}.adaLN_modulation.0.lora_up.weight",
                    f"{layer_type}.{{block}}.adaLN_modulation.0.lora_up.default.weight",
                    f"lora_unet_{layer_type}_{{block}}_adaLN_modulation_0.lora_up.weight",
                    f"lora_unet_{layer_type}_{{block}}_adaLN_modulation_0.lora_up.default.weight",
                ],
                possible_down_patterns=[
                    f"diffusion_model.{layer_type}.{{block}}.adaLN_modulation.0.lora_A.weight",
                    f"diffusion_model.{layer_type}.{{block}}.adaLN_modulation.0.lora_A.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.adaLN_modulation.0.lora_down.weight",
                    f"diffusion_model.{layer_type}.{{block}}.adaLN_modulation.0.lora_down.default.weight",
                    f"transformer.{layer_type}.{{block}}.adaLN_modulation.0.lora_A.weight",
                    f"transformer.{layer_type}.{{block}}.adaLN_modulation.0.lora_A.default.weight",
                    f"transformer.{layer_type}.{{block}}.adaLN_modulation.0.lora_down.weight",
                    f"transformer.{layer_type}.{{block}}.adaLN_modulation.0.lora_down.default.weight",
                    f"{layer_type}.{{block}}.adaLN_modulation.0.lora_A.weight",
                    f"{layer_type}.{{block}}.adaLN_modulation.0.lora_A.default.weight",
                    f"{layer_type}.{{block}}.adaLN_modulation.0.lora_down.weight",
                    f"{layer_type}.{{block}}.adaLN_modulation.0.lora_down.default.weight",
                    f"lora_unet_{layer_type}_{{block}}_adaLN_modulation_0.lora_down.weight",
                    f"lora_unet_{layer_type}_{{block}}_adaLN_modulation_0.lora_down.default.weight",
                ],
            ...
            LoRATarget(
                ...
                possible_up_patterns=[
                    ...
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_q.lora_B.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_q.lora_up.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_q.lora_up.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_q.lora_B.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_q.lora_B.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_q.lora_up.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_q.lora_up.default.weight",
                    f"{layer_type}.{{block}}.attention.to_q.lora_B.weight",
                    f"{layer_type}.{{block}}.attention.to_q.lora_B.default.weight",
                    f"{layer_type}.{{block}}.attention.to_q.lora_up.weight",
                    f"{layer_type}.{{block}}.attention.to_q.lora_up.default.weight",
                    f"lora_unet_{layer_type}_{{block}}_attention_to_q.lora_up.weight",
                    f"lora_unet_{layer_type}_{{block}}_attention_to_q.lora_up.default.weight",
                ],
                possible_down_patterns=[
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_q.lora_A.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_q.lora_A.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_q.lora_down.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_q.lora_down.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_q.lora_A.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_q.lora_A.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_q.lora_down.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_q.lora_down.default.weight",
                    f"{layer_type}.{{block}}.attention.to_q.lora_A.weight",
                    f"{layer_type}.{{block}}.attention.to_q.lora_A.default.weight",
                    f"{layer_type}.{{block}}.attention.to_q.lora_down.weight",
                    f"{layer_type}.{{block}}.attention.to_q.lora_down.default.weight",
                    f"lora_unet_{layer_type}_{{block}}_attention_to_q.lora_down.weight",
                    f"lora_unet_{layer_type}_{{block}}_attention_to_q.lora_down.default.weight",
                ],
                possible_alpha_patterns=[
            ...
            LoRATarget(
                ...
                possible_up_patterns=[
                    ...
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_k.lora_B.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_k.lora_up.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_k.lora_up.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_k.lora_B.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_k.lora_B.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_k.lora_up.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_k.lora_up.default.weight",
                    f"{layer_type}.{{block}}.attention.to_k.lora_B.weight",
                    f"{layer_type}.{{block}}.attention.to_k.lora_B.default.weight",
                    f"{layer_type}.{{block}}.attention.to_k.lora_up.weight",
                    f"{layer_type}.{{block}}.attention.to_k.lora_up.default.weight",
                    f"lora_unet_{layer_type}_{{block}}_attention_to_k.lora_up.weight",
                    f"lora_unet_{layer_type}_{{block}}_attention_to_k.lora_up.default.weight",
                ],
                possible_down_patterns=[
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_k.lora_A.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_k.lora_A.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_k.lora_down.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_k.lora_down.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_k.lora_A.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_k.lora_A.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_k.lora_down.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_k.lora_down.default.weight",
                    f"{layer_type}.{{block}}.attention.to_k.lora_A.weight",
                    f"{layer_type}.{{block}}.attention.to_k.lora_A.default.weight",
                    f"{layer_type}.{{block}}.attention.to_k.lora_down.weight",
                    f"{layer_type}.{{block}}.attention.to_k.lora_down.default.weight",
                    f"lora_unet_{layer_type}_{{block}}_attention_to_k.lora_down.weight",
                    f"lora_unet_{layer_type}_{{block}}_attention_to_k.lora_down.default.weight",
                ],
                possible_alpha_patterns=[
            ...
            LoRATarget(
                ...
                possible_up_patterns=[
                    ...
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_v.lora_B.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_v.lora_up.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_v.lora_up.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_v.lora_B.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_v.lora_B.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_v.lora_up.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_v.lora_up.default.weight",
                    f"{layer_type}.{{block}}.attention.to_v.lora_B.weight",
                    f"{layer_type}.{{block}}.attention.to_v.lora_B.default.weight",
                    f"{layer_type}.{{block}}.attention.to_v.lora_up.weight",
                    f"{layer_type}.{{block}}.attention.to_v.lora_up.default.weight",
                    f"lora_unet_{layer_type}_{{block}}_attention_to_v.lora_up.weight",
                    f"lora_unet_{layer_type}_{{block}}_attention_to_v.lora_up.default.weight",
                ],
                possible_down_patterns=[
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_v.lora_A.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_v.lora_A.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_v.lora_down.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_v.lora_down.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_v.lora_A.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_v.lora_A.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_v.lora_down.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_v.lora_down.default.weight",
                    f"{layer_type}.{{block}}.attention.to_v.lora_A.weight",
                    f"{layer_type}.{{block}}.attention.to_v.lora_A.default.weight",
                    f"{layer_type}.{{block}}.attention.to_v.lora_down.weight",
                    f"{layer_type}.{{block}}.attention.to_v.lora_down.default.weight",
                    f"lora_unet_{layer_type}_{{block}}_attention_to_v.lora_down.weight",
                    f"lora_unet_{layer_type}_{{block}}_attention_to_v.lora_down.default.weight",
                ],
                possible_alpha_patterns=[
            ...
            LoRATarget(
                ...
                possible_up_patterns=[
                    ...
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_out.0.lora_B.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_out.0.lora_up.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_out.0.lora_up.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.out.lora_B.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.out.lora_B.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.out.lora_up.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.out.lora_up.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_out.0.lora_B.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_out.0.lora_B.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_out.0.lora_up.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_out.0.lora_up.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.out.lora_B.weight",
                    f"transformer.{layer_type}.{{block}}.attention.out.lora_B.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.out.lora_up.weight",
                    f"transformer.{layer_type}.{{block}}.attention.out.lora_up.default.weight",
                    f"{layer_type}.{{block}}.attention.to_out.0.lora_B.weight",
                    f"{layer_type}.{{block}}.attention.to_out.0.lora_B.default.weight",
                    f"{layer_type}.{{block}}.attention.to_out.0.lora_up.weight",
                    f"{layer_type}.{{block}}.attention.to_out.0.lora_up.default.weight",
                    f"lora_unet_{layer_type}_{{block}}_attention_to_out_0.lora_up.weight",
                    f"lora_unet_{layer_type}_{{block}}_attention_to_out_0.lora_up.default.weight",
                ],
                possible_down_patterns=[
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_out.0.lora_A.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_out.0.lora_A.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_out.0.lora_down.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.to_out.0.lora_down.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.out.lora_A.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.out.lora_A.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.out.lora_down.weight",
                    f"diffusion_model.{layer_type}.{{block}}.attention.out.lora_down.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_out.0.lora_A.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_out.0.lora_A.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_out.0.lora_down.weight",
                    f"transformer.{layer_type}.{{block}}.attention.to_out.0.lora_down.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.out.lora_A.weight",
                    f"transformer.{layer_type}.{{block}}.attention.out.lora_A.default.weight",
                    f"transformer.{layer_type}.{{block}}.attention.out.lora_down.weight",
                    f"transformer.{layer_type}.{{block}}.attention.out.lora_down.default.weight",
                    f"{layer_type}.{{block}}.attention.to_out.0.lora_A.weight",
                    f"{layer_type}.{{block}}.attention.to_out.0.lora_A.default.weight",
                    f"{layer_type}.{{block}}.attention.to_out.0.lora_down.weight",
                    f"{layer_type}.{{block}}.attention.to_out.0.lora_down.default.weight",
                    f"lora_unet_{layer_type}_{{block}}_attention_to_out_0.lora_down.weight",
                    f"lora_unet_{layer_type}_{{block}}_attention_to_out_0.lora_down.default.weight",
                ],
                possible_alpha_patterns=[
            ...
            LoRATarget(
                ...
                possible_up_patterns=[
                    ...
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w1.lora_B.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w1.lora_up.weight",
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w1.lora_up.default.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w1.lora_B.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w1.lora_B.default.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w1.lora_up.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w1.lora_up.default.weight",
                    f"{layer_type}.{{block}}.feed_forward.w1.lora_B.weight",
                    f"{layer_type}.{{block}}.feed_forward.w1.lora_B.default.weight",
                    f"{layer_type}.{{block}}.feed_forward.w1.lora_up.weight",
                    f"{layer_type}.{{block}}.feed_forward.w1.lora_up.default.weight",
                    f"lora_unet_{layer_type}_{{block}}_feed_forward_w1.lora_up.weight",
                    f"lora_unet_{layer_type}_{{block}}_feed_forward_w1.lora_up.default.weight",
                ],
                possible_down_patterns=[
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w1.lora_A.weight",
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w1.lora_A.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w1.lora_down.weight",
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w1.lora_down.default.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w1.lora_A.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w1.lora_A.default.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w1.lora_down.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w1.lora_down.default.weight",
                    f"{layer_type}.{{block}}.feed_forward.w1.lora_A.weight",
                    f"{layer_type}.{{block}}.feed_forward.w1.lora_A.default.weight",
                    f"{layer_type}.{{block}}.feed_forward.w1.lora_down.weight",
                    f"{layer_type}.{{block}}.feed_forward.w1.lora_down.default.weight",
                    f"lora_unet_{layer_type}_{{block}}_feed_forward_w1.lora_down.weight",
                    f"lora_unet_{layer_type}_{{block}}_feed_forward_w1.lora_down.default.weight",
                ],
                possible_alpha_patterns=[
            ...
            LoRATarget(
                ...
                possible_up_patterns=[
                    ...
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w2.lora_B.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w2.lora_up.weight",
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w2.lora_up.default.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w2.lora_B.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w2.lora_B.default.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w2.lora_up.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w2.lora_up.default.weight",
                    f"{layer_type}.{{block}}.feed_forward.w2.lora_B.weight",
                    f"{layer_type}.{{block}}.feed_forward.w2.lora_B.default.weight",
                    f"{layer_type}.{{block}}.feed_forward.w2.lora_up.weight",
                    f"{layer_type}.{{block}}.feed_forward.w2.lora_up.default.weight",
                    f"lora_unet_{layer_type}_{{block}}_feed_forward_w2.lora_up.weight",
                    f"lora_unet_{layer_type}_{{block}}_feed_forward_w2.lora_up.default.weight",
                ],
                possible_down_patterns=[
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w2.lora_A.weight",
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w2.lora_A.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w2.lora_down.weight",
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w2.lora_down.default.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w2.lora_A.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w2.lora_A.default.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w2.lora_down.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w2.lora_down.default.weight",
                    f"{layer_type}.{{block}}.feed_forward.w2.lora_A.weight",
                    f"{layer_type}.{{block}}.feed_forward.w2.lora_A.default.weight",
                    f"{layer_type}.{{block}}.feed_forward.w2.lora_down.weight",
                    f"{layer_type}.{{block}}.feed_forward.w2.lora_down.default.weight",
                    f"lora_unet_{layer_type}_{{block}}_feed_forward_w2.lora_down.weight",
                    f"lora_unet_{layer_type}_{{block}}_feed_forward_w2.lora_down.default.weight",
                ],
                possible_alpha_patterns=[
            ...
            LoRATarget(
                ...
                possible_up_patterns=[
                    ...
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w3.lora_B.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w3.lora_up.weight",
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w3.lora_up.default.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w3.lora_B.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w3.lora_B.default.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w3.lora_up.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w3.lora_up.default.weight",
                    f"{layer_type}.{{block}}.feed_forward.w3.lora_B.weight",
                    f"{layer_type}.{{block}}.feed_forward.w3.lora_B.default.weight",
                    f"{layer_type}.{{block}}.feed_forward.w3.lora_up.weight",
                    f"{layer_type}.{{block}}.feed_forward.w3.lora_up.default.weight",
                    f"lora_unet_{layer_type}_{{block}}_feed_forward_w3.lora_up.weight",
                    f"lora_unet_{layer_type}_{{block}}_feed_forward_w3.lora_up.default.weight",
                ],
                possible_down_patterns=[
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w3.lora_A.weight",
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w3.lora_A.default.weight",
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w3.lora_down.weight",
                    f"diffusion_model.{layer_type}.{{block}}.feed_forward.w3.lora_down.default.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w3.lora_A.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w3.lora_A.default.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w3.lora_down.weight",
                    f"transformer.{layer_type}.{{block}}.feed_forward.w3.lora_down.default.weight",
                    f"{layer_type}.{{block}}.feed_forward.w3.lora_A.weight",
                    f"{layer_type}.{{block}}.feed_forward.w3.lora_A.default.weight",
                    f"{layer_type}.{{block}}.feed_forward.w3.lora_down.weight",
                    f"{layer_type}.{{block}}.feed_forward.w3.lora_down.default.weight",
                    f"lora_unet_{layer_type}_{{block}}_feed_forward_w3.lora_down.weight",
                    f"lora_unet_{layer_type}_{{block}}_feed_forward_w3.lora_down.default.weight",
                ],
                possible_alpha_patterns=[
