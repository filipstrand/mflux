"""
Exponential Moving Average (EMA) for Z-Image Model Weights.
...
class EMAModel:
    ...
    def __init__(self, model: nn.Module, decay: float = 0.9999):
        ...
        # Force evaluation to materialize shadow weights (mx.eval is MLX's lazy evaluation trigger)
    ...
    def update(self, model: nn.Module) -> None:
        ...
        # Force evaluation to prevent lazy graph buildup (mx.eval is MLX's lazy evaluation trigger)
        mx.eval(self._shadow)
