...
class QwenPromptEncoder:
    ...
    def encode_prompt(
        ...
        prompt_embeds, prompt_mask = qwen_text_encoder(input_ids=input_ids, attention_mask=attention_mask, template_start_idx=0)
        neg_prompt_embeds, neg_prompt_mask = qwen_text_encoder(input_ids=neg_input_ids, attention_mask=neg_attention_mask, template_start_idx=0)
