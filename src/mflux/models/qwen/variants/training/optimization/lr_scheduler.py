"""
Learning Rate Schedulers for Qwen-Image Training.
...
def create_scheduler(
    ...
    **kwargs,
    ...
    Args:
        name: Scheduler name ("cosine", "onecycle", or "linear_warmup")
        optimizer: MLX optimizer to adjust
    ...
    if name_lower in ("cosine", "cosineannealing", "cosinelr"):
        ...
        raise ValueError(f"Unknown scheduler: {name}. Supported: cosine, onecycle, linear_warmup")
