...
class Krea2Initializer:
    ...
    def init(
        ...
        tokenizer_path = Krea2WeightDefinition.tokenizer_path_for(model_config, path)
        Krea2Initializer._init_config(model, model_config)
        weights = Krea2Initializer._load_weights(weight_definition, path)
    ...
    @staticmethod
    def _load_weights(weight_definition, model_path: str) -> LoadedWeights:
    ...
    @staticmethod
    def _init_tokenizers(model, weight_definition, model_path: str) -> None:
