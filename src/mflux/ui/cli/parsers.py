...
class CommandLineParser(argparse.ArgumentParser):
    ...
    def add_general_arguments(self) -> None:
        ...
        self.add_argument("--flux_vae-tiling", action="store_true", help="Enable VAE tiling to reduce memory usage at the cost of a potential seam")
        self.add_argument("--flux_vae-tiling-split", type=str, choices=["horizontal", "vertical"], default="horizontal", help="Direction to split the latents when using VAE tiling (horizontal = top/bottom, vertical = left/right). Default is horizontal.")
