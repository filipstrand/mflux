...
class CommandLineParser(argparse.ArgumentParser):
    ...
    def add_lora_arguments(self) -> None:  # fmt: off
        ...
        lora_group.add_argument("--lora-paths", type=str, nargs="+", help="Paths to LoRA files to apply")
        lora_group.add_argument("--lora-scales", type=float, nargs="+", default=[1.0], help="Scales to apply to each LoRA (default: 1.0)")
