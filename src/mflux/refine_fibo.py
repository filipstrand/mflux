...
def main():
    ...
    parser.add_argument("--output", type=Path, default=Path("refined.prompt.json"), help="Output path for refined JSON prompt (default: refined.prompt.json)")
