...
class ImageGeneratorZImageTestHelper:
    ...
    def clear_cached_lora(pattern: str) -> None:
        """Clear cached LoRA files matching the pattern to test download functionality.

        Args:
            pattern: A substring to match against cached directories (e.g., 'Technically-Color')
        """
