...
class SkyReelsV2Pipeline(DiffusionPipeline, SkyReelsV2LoraLoaderMixin):
    ...
    def __init__(
        ...
        self.vae_scale_factor_temporal = 2 ** sum(self.vae.temporal_downsample) if getattr(self, "vae", None) else 4
        self.vae_scale_factor_spatial = 2 ** len(self.vae.temporal_downsample) if getattr(self, "vae", None) else 8
