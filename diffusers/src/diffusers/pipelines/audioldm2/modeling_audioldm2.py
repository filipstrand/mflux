...
class AudioLDM2ProjectionModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        self.sos_embed = nn.Parameter(torch.ones(language_model_dim))
        self.eos_embed = nn.Parameter(torch.ones(language_model_dim))

        self.sos_embed_1 = nn.Parameter(torch.ones(language_model_dim))
        self.eos_embed_1 = nn.Parameter(torch.ones(language_model_dim))
