...
class UniDiffuserModel(ModelMixin, ConfigMixin):
    ...
    Parameters:
        ...
        use_data_type_embedding (`bool`, *optional*):
            ...
            is continue-trained from UniDiffuser-v0 on non-publicly-available data and accepts a `data_type`
            argument, which can either be `1` to use the weights trained on non-publicly-available data or `0`
