...
class WanResidualDownBlock(nn.Module):
    def __init__(self, in_dim, out_dim, dropout, num_res_blocks, temporal_downsample=False, down_flag=False):
        super().__init__()
            ...
            if is_residual:
                self.down_blocks.append(
                    WanResidualDownBlock(
                        ...
                        dropout,
                        num_res_blocks,
                        temporal_downsample=temporal_downsample[i] if i != len(dim_mult) - 1 else False,
